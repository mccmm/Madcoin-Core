...
This mechanism has been integrated into Bitcore-Node-Madcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/madcoincoin/insight-api-madcoin#web-socket-api](https://github.com/madcoincoin/insight-api-madcoin#web-socket-api) 
* API: [https://github.com/madcoincoin/insight-api-madcoin#instantsend-transactions](https://github.com/madcoincoin/insight-api-madcoin#instantsend-transactions) 
...
By default, the Madcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Madcoin Core daemon:

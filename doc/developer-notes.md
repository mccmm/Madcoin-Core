...
Madcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadRPCServer : Remote procedure call handler, listens on port 11998 for connections and services them.
...
However, in open source software such as Madcoin Core, where everyone uses
...
pay attention to for reviewers of Madcoin Core code.

General Madcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Madcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion

...
Only requiring some minor changes is madcoin.cpp.
...
Changes to madcoin.cpp
----------------------
madcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

...
Madcoin Core version 0.12.0 is now available from:

  https://madcoincoin.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/madcoincoin/madcoin/issues
...
backwards-compatible with pre-0.12 versions of Madcoin Core or other software:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/madcoin/).

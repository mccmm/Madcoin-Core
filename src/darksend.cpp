...
{
    if(fLiteMode) return; // ignore all Madcoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Madcoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("madcoin-privatesend");

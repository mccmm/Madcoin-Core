 ...
 *
 *   // network
 *   CMadcoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.madcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMadcoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CMadcoinNetwork(UniValue objIn)
    {
...
// // can be under: MadcoinNetwork
// //   -- signature requirements : Key1(User)
// class CMadcoinNetworkVariable : public CGovernanceObject
// {
// private:

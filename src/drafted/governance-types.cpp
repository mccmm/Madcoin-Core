...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MadcoinNetwork") type = MadcoinNetwork;
    if(strType == "MadcoinNetworkVariable") type = MadcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MadcoinNetwork) s = "MadcoinNetwork";
    if(type == MadcoinNetworkVariable) s = "MadcoinNetworkVariable";

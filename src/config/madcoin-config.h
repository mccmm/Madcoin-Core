/* src/config/madcoin-config.h.  Generated from madcoin-config.h.in by configure.  */
/* src/config/madcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/madcoincoin/madcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Madcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Madcoin Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "madcoincore"

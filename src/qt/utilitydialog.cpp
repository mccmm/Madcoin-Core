    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Madcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Madcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  madcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Madcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MDC, 0.1 MDC, 1 MDC and 10 MDC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://madcoin.space/wiki/display/DOC/PrivateSend\">https://madcoin.space/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Madcoin Core is shutting down...") + "<br /><br />" +

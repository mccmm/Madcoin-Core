    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Madcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Madcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and madcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Madcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Madcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Madcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Madcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Madcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a madcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Madcoin Core help message to get a list with possible Madcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Madcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Madcoin network", "", count));
}
...
{
    QString strTitle = tr("Madcoin Core"); // default title

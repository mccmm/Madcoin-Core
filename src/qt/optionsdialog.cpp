    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MDC-light"), QVariant("light"));
    ui->theme->addItem(QString("MDC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MDC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MDC-traditional"), QVariant("trad"));
